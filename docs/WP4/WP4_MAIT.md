...
[RD001] Gimbal Mount Assembly - Definition File / Version 001  

[RD002] Gimbal Mount Assembly - Interface Control Document / Version 001  

[RD003] Data Sheet - ARMCO 17-4PH / 2022  

[RD004] Instructions for Double Anvil Spherical Bearing Swaging Tool #10 Wide / Pegasus Auto Racing Supplies, Inc.  

[RD005] Bearing Installation and Retention by Swaging or Staking / AIA - NAS0331 / 2013  

[RD006] NASA Reference Publication 1228 - Fastener Design Manual / RichaRD0 T.Barrett / 1990  

[RD007] Nyx Moon - Huracan Development Logic / TEC-FRA-DOC-2024-01004 / Issue 02  

[RD008] Gimbal Mount Assembly - Justification File/ Version 001  

[RD009] Structural Design and Test Factors of Safety For Spaceflight HaRD0ware / NASA-STD-5001B / Change 3 /

[RD010] Gimbal Mount Assembly - Preliminary Verification Control Document / Version 001  

[RD011] Nyx Moon - Huracan Overall Test Plan / TEC-FRA-DOC-2024-01005/ Issue 01  

[RD012] Bearings, Plain, Self-Aligning, Self-Lubricating, Low Speed Oscillation, General Specification / MIL-B-81820E / 1986
...
The Gimbal Mount Assembly (GMA) is the primary thrust-transmitting interface between the engine and vehicle. It transfers engine thrust to the vehicle structure and permits engine gimbaling for thrust-vector control. The design is defined in the Definition File [RD01] and Interface Control Document [RD02].  

![GMA isometric view](../WP3/figures/GMA_isometric.png){width=40%}

# 3. Manufacturing  

Manufacturing shall follow the company's approved processes from material procurement through final machining and quality control. Figure 2 shows the custom-machined parts. All other parts are Commercial Off-The-Shelf (COTS) items, as defined in [RD01].  

![Custom machined parts of the TMA](../WP3/figures/GMA_explosion_custom.png){width=50%}

## 3.1. Materials and Heat Treatment

All custom machined parts of the GMA (Figure 2) are made of martensitic precipitation haRD0ened stainless steel, that combines high strength, excellent corrosion resistance, easy heat treatment and comparable thermal expansion w.r.t Inconel 718 (engine). As one of the main structural parts of the engine, the GMA is treated as a critical application. For this, the material shall be sourced in a precipitation haRD0ned condition. The final material choice is **17-4PH - H900**, while the suffix expresses the heat treatment condition. The figure below shows a general overview of material properties as a function of the precipitation haRD0ened conditions ranging from *H900* to *H1150M*.

![17-4PH, Typical Mechanical Properties - Bar [RD03]](<../WP3/figures/17-4PH properties.png>){width=80%}  
...
- Double Anvil Spherical bearing Swaging Tool for Spherical Bearing *MS14103-10* accoRD0ing to [RD05]
...
Insert the Bushing (5) through the larger Clevis bore from the opposite side. Push it inwaRD0 until it contacts the bearing inner race.
...
The NAS bolt (6) is then tightened with the Castellated Nut (7) to a **minimum torque of 5 Nm**, ensuring that the stacked components are fully seated and free of axial play. After it is ensured that no clearance exists between all stacked parts, the Nut´s preload is then increased by **17 Nm +/-2 Nm**. The final torque is reached, when the next slot of the Castellated Nut aligns with the drilled hole of the NAS-bolt in oRD0er to lock the thread with the Cotter Pin (8). This final applied torque is to be recoRD0ed.   

After appliction of the torque, both parts shall be secured from loosening with the Cotter Pin (8). In accoRD0ane to NASA recommendations [RD06], the Cotter Pin shall be bended as illustrated in Figure 5.  

![Bending of Cotter Pin [RD06]](<../WP3/figures/GMA_NASA_thread locking.png>){width=40%}  

# 5. Integration  

After the GMA is assembled, the GMA is integrated with the engine-side and vehicle-side structures.  

The GMA is not attached directly to the engine or vehicle. It interfaces with the engine through the Thrust Dome and with the vehicle through four Thrust Frame Beams [RD01], [RD02].  
...
**GMA-Vehicle**  
Sixteen fasteners, including bolts, washers, and nuts, connect the GMA Clevis Head to the four Thrust Frame Beams [RD02]. Figure 7 shows their configuration and orientation.  

![Interface assembly - GMA Clevis Head and Thrust Frame Beams](<../WP3/figures/GMA_vehicle interface.png>){width=55%}  

Before tightening, position all beams against the four centring features defined in [RD02]. Full seating and correct beam orientation is to be confirmed.  
...
Figure 8 shows the view towaRD0 the Thrust Frame Beams in the yz-plane, with the GMA Clevis Head hidden. The thrust vector F_thrust points into the image plane. The blue fasteners are parallel to F_thrust, while the red fasteners lie in the yz-plane.  
...
| ------ | ----- | ----- | ----- | 
| GMA Lug Head - Thrust Dome          |Through-Thread  | ISO4017-M6x16-A4-70  | 7.2 |
| GMA Clevis Head - Thrust Frame Beam |Through-Thread  | ISO4017-M6x16-A4-70  | 7.2 |
| GMA Clevis Head - Thrust Frame Beam |Bolt-Nut        | ISO4017-M6x25-A4-70  | 7.2 |
...
Acceptance Tests are performed on each manufactured part to verify conformity, workmanship, structural integrity, and basic functionality before assembly to a component and higher-level engine system testing later. After GMA component acceptance tests, the haRD0ware proceeds to a subsystem testing in the *H05* campaign, which also encompasses the TVC-actuators and the bellows with representative routed and pressurized ducts. *H05* is understood as part of acceptance that is required for early derisking and entry of engine-level testing in the frame of Development Tests. 
...
dimensions. Material certificate and heat treatment recoRD0s are to be reviewed. Geometric dimensioning and tolerancing against the manufacturing drawings are to be verified.  

COTS parts are to be inspected against their procurement specificaitons and certificates. Part numbers, serial or lot numbers are to be recoRD0ed where applicable.  

After swaging, the bearing installation is to be inspected in accoRD0ance with [RD04] and Method 100 of [RD05]. Swage dimensions, bearing position, surface condition, and breakaway torque are to be recoRD0ed.  
...
| Material anomalies |Certificates and recoRD0s conform to the drawing and purchase oRD0er|
...
| Swaged installation |Complies with the approved process and gauging criteria in [RD04] and [RD05] |
: Sucess criteria for Inspection  

### 6.2.2. Proof Tests  

Per NASA definition [RD09] a Proof Test shall screen defects in workmannship, material quality to verify structural
...
Considering the conservative load assumptions during the theoretical analysis in [RD08], the load capabilities of
the military-rated COTS parts (Bolt, Nut, Bearing) and the chosen material, no testing shall be executed to
verify load-related verification requirements listed in [RD010]. Here, the verification by analysis only shall be
...
Unlike described in [RD05], the Spherical Bearing MS14103-10 shall not be proof tested for push out of the bearing. Instead, after the swaging process, the bearing groove shall be gauged as stated in [RD04] or respectively shown in chatper 7.1. A push out test is not desired as long as the swaging process is consistently followed in alignment to recommendations in [RD04].  

### 6.2.3. Functional Tests  

**Gimbal angle**  
The gimbal angle of the GMA Lug Head about the z-axis (yaw) is limited by Mechanical Stops to a nominal value of ±12 ° [RD01]. The gimbal angle about the y-axis (pitch) is limited by the available stroke of the TVC actuators.  
...
As the GMA Lug Head is displaced towaRD0 the maximum roll angle, contact shall occur between the Anti-Roll Features of the GMA Lug Head and the corresponding inner surfaces of the GMA Clevis Head.  

Like specified in [RD01], when the maximum yaw angle is reached, the designated Mechanical Stops within the GMA Clevis Head shall be the first features to make contact. Any prior contact between the GMA Clevis Head and the bolt, or between the GMA Clevis Head and any other component or surface with limited clearance, is not permissible.  
...
- *Bearing-only condition*:  
  The breakaway torque of the uninstalled bearing shall be measured in accoRD0ance with the applicable requirements of *MS14103*.
...
Development tests are conducted during the design-maturation phase to build confidence in new designs and concepts and to support the objectives of the Overall Test Plan at engine-system level in accoRD0ance with [RD011].   
...
The Overall Test Plan [RD011] will be updated because TVC is not included in the current version issued at the Preliminary Design Review. Consequently, system-level objectives related to TVC have not yet been defined. Nevertheless, preliminary component-level objectives can be derived from the current development status of the GMA and from the requirements specified in [RD010].

The Overall Test Plan [RD011] will be updated as TVC is not part of the current version from the Preliminary Design Review. Hence, the objectives w.r.t. to the TVC are not yet defined on a system level. Some objectives, however, can be derived based on the current developoment state of the GMA from a component level and the requirements stated in [RD010].  
...
**MAIT**  
The MAIT-related objectives are primarily associated with the swaging of the spherical bearing into the GMA Lug Head bore. During development testing, it shall be demonstrated that TEC can control and perform the swaging process in accoRD0ance with [RD05].  
...
The objective is to monitor the condition of the *MS14103-10* Spherical Bearing throughout the engine test campaign and to determine whether it remains suitable for continued use. Ideally, the initial condition of the bearing shall be recoRD0ed before the first test and reassessed after each test sequence. However, the inspection intervals shall be cooRD0inated with the other engine test objectives and the schedule and cost constraints of the test campaign, as additional measurement activities may increase test turnaround time and reduce the time available for testing.   
...
![MIL-B-81820 measurement of radial play [RD012]](<../WP3/figures/GMA_MILB81820E_wear rad. measurement.png>){width=50%}  
...
The qualification-test objectives are assumed to be defined and executed at engine-system level. AccoRD0ingly, the applicable qualification objectives, test conditions, procedures, and success criteria are specified in the Huracan Overall Test Plan [RD02].  
...
![User instructions for swaging [RD04]](<../WP3/figures/Pegasus_instructions bearing swaging.png>){width=70%}  

\clearpage    

![Anvil swaging [RD04]](<../WP3/figures/Pegasus_instructions bearing swaging_Fig4.png>){width=60%}  
  

![Gauging of swaged bearing [RD04]](<../WP3/figures/Pegasus_instructions bearing swaging_Fig5.png>){width=60%}  
...
![MIL-B-81820 oscillating under load [RD012]](<../WP3/figures/GMA_MILB81820E_oscillating test.png>){width=80%}    
