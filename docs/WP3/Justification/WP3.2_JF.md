...
For the thermal analysis, *ANSYS Workbench 2024 R2* is utilized. The results and related conclusions and comments are presented subsequently.
...
![Results of Thermal Transient Analysis for 60 s and 500 s](<../figures/FEM_thermal transient.png>){width=80%}  
...
![GMA global Contact Status - 22.5kN Thrust Load - pitch 0°/yaw 0°](../figures/FEM_contact_thrustload_status.png){width=60%}  
...
![GMA global Contact Friction Stresses - 22.5kN Thrust Load - pitch 0°/yaw 0°](<../figures/FEM_contact_thrustload_fr stress.png>){width=60%}    
...
![GMA local Total Deformation - 22.5kN Thrust Load - pitch 0°/yaw 0°](<../figures/FEM_deformation_thrust load2.png>){width=50%}  
...
### 4.1.3. Results: Von Mises Stresses  
  
The figures below show the von Mises Stresses from the global GMA component up to its single parts.  

![GMA global von Mises Stresses - 22.5kN Thrust Load - pitch 0°/yaw 0°](../figures/FEM_stress_thrustload_global.png){width=80%}  

![GMA Lug Head and Clevis von Mises Stresses - 22.5kN Thrust -pitch 0°/yaw 0°](../figures/FEM_stress_thrustload_clevis_lug.png){width=80%}   

![Spacer/Bushing and Bolt/Nut von Mises Stresses - 22.5kN Thrust -pitch 0°/yaw 0°](../figures/FEM_stress_thrustload_bolt_spacers.png){width=70%}  
...
### 4.1.4. Chosen parts under Thrust Load  
...
![GMA Lug Head von Mises Stresses - 22.5kN Thrust Load - pitch 12°/yaw -12°](../figures/GMA_Lug_stress_p12_y-12.png){width=40%}  
...
![GMA Bushing, Spacer von Mises Stresses - 22.5kN Thrust Load - pitch 12°/yaw -12°](../figures/GMA_Bushing_Spacer_stress_p12_y-12.png){width=40%}  
...
## 4.2. Flange Fasteners  

### 4.2.1. Results: Force Reaction
...
![GMA - Reaction Forces - different gimbal angles 1_2](<../figures/GMA_fastener reaction 1_2.png>){width=70%}   

![GMA - Reaction Forces - different gimbal angles 2_2](<../figures/GMA_fastener reaction 2_2.png>){width=50%}  

### 4.2.2. Results: Margin of Safety & Torques
...
![GMA Fastener MOS](../figures/GMA_Fasteners_MOS.png){width=70%}  
...
![Frictional Stresses with/without preload of NAS-bolt](<../figures/FEM_NASbolt preload friction stress.png>){width=50%}  

![Von Mises Stresses with/without preload of NAS-bolt](<../figures/FEM_NASbolt stresses.png>){width=50%}  
...
## 6.3. Boundary Conditions Static-Structural Analysis  

![Static-Structural Analysis - Contact Definition](../figures/FEM_bc_contacts.png){width=70%}   

![Static-Structural Analysis - Details of Beams/Fasteners](../figures/FEM_bc_fasteners_beams.png){width=40%}  

![Static-Structural Analysis - Fixed support and Reaction Forces](../figures/FEM_bc_fixation.png){width=90%}    

![Static-Structural Analysis - Mesh](../figures/FEM_bc_mesh.png){width=90%}    

![Static-Structural Analysis - Mesh Details](<../figures/FEM_bc_mesh details.png>){width=35%}  

![Static-Structural Analysis - Load Definition](../figures/FEM_bc_load.png){width=70%}  

![Static-Structural Analysis - NAS-Bolt Preload](<../figures/FEM_bc_NASbolt preload.png>){width=50%}   

![Static-Structural Analysis - Flange Fasteners Preload](<../figures/FEM_bc_fasteners preload.png>){width=45%}    

![Static-Structural Analysis - Analysis Settings](<../figures/FEM_bc_analysis settings.png>){width=40%}  
...
## 6.5. Static-Structural: GMA - pitch 0°, yaw 0° - Acceleration Load  
...
## 6.6. Static-Structural: Thrust Dome / Beams - Thrust Load  
...
## 6.7. Static-Structural: Thrust Dome / Beams - Acceleration Load  
